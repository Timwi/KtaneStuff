...
namespace KtaneStuff
{
    static class DragonEnergy
    {
        ...
        {
            var data = @"Angry=怒;Dragon=龍;Friend=友;Loyal=忠;Heart=心;Blessing=福;Dream=夢;Hate=懟;Magic=魔;River=川;Child=子;Energy=能;Hope=願;Male=男;Emotion=感;Curse=咒;Female=女;Kind=類;Mountain=山;Soul=魂;Heaven=天;Force=力;Longevity=壽;Night=晚;Urgency=急;Delight=喜;Forest=森;Love=愛;Pure=純;Wind=風"
